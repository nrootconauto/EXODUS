...
- Fs and Gs are bit pointers instead of the whole structures located at gs:0x28 and gs:0x50 respectively [(blame microsoft)](https://en.wikipedia.org/wiki/Win32_Thread_Information_Block#Contents_of_the_TIB_on_Windows)
